...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($item_names as $key => $item_name) {
        ...
        $stmt = $con->prepare("INSERT INTO materials_assign (item_names, lab_name, assign_number, faculty_name, faculty_assign_number) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("sssss", $item_name, $lab_name, $assign_number, $faculty_name, $faculty_assign_number);
...
?>
  <?php 
    // Check if the item name is provided in the URL
    if(isset($_GET['item_name'])) {
        $item_name = $_GET['item_name'];
        // Use $item_name as needed
    } else {
...
<header>
    ...
    <nav>
        ...
        <a href="home.php"><input type="image" src="images/icons/home.png" title="Home" alt="Home"></a>
        <a href="profile.php"><input type="image" src="images/icons/user.png" title="Profile" alt="Profile"></a>
        <a href="logout.php"><input type="image" src="images/icons/logout.png" title="Logout" alt="Logout"></a>
    </nav>
</header>

<div id="page">
    <div id="topic"><h3><?php echo $item_name; ?></h3></div>
            ...
            <div id="faculty-fields">
                ...
                <div class="faculty-row">
                    <div class="faculty-input">
                        ...
                        <input type="text" name="item_names[]" value="<?php echo $item_name; ?>" placeholder="Item Names" required>
                    </div>
                    <div class="faculty-input">
